...
namespace MercDevs_ej2.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Descripcionservicios(int? id)
        {
            if (id == null)
            {
                return NotFound();
            ...
            var descripciones = servicio.Descripcionservicios;
            return View(descripciones); // Devolver la vista y pasar la colección de descripciones como modelo
        }
        // GET: Servicios
